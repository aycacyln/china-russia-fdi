...
df_all = df[df["Country/Territory"].isin(countries)][["Country/Territory", "DYY_Çin", "Çin ile oy uyumu"]].dropna()

x_all = df_all["DYY_Çin"]
y_all = df_all["Çin ile oy uyumu"]
...
#plt.title("Çin’den Gelen DYY ile Çin ile BM Oy Uyumu (Birleşik Kuadratik Model)")
